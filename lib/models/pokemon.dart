import 'package:flutter_app_alti/models/evolution.dart';
...
class Pokemon {
  ...
  factory Pokemon.fromJson(Map<String, dynamic> json) => Pokemon(
        ...
        weaknesses:
            json["weaknesses"] == null ? null : List<String>.from(json["weaknesses"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "next_evolution":
            nextEvolution == null ? null : List<dynamic>.from(nextEvolution.map((x) => x.toJson())),
        "prev_evolution":
            prevEvolution == null ? null : List<dynamic>.from(prevEvolution.map((x) => x.toJson())),
      };
}
